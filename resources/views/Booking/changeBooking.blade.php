...
<input type="hidden" class="form-control" name="sah_tukar" value="" />
...
<table align="center" border="0" cellpadding="1" cellspacing="1" style="width:600px">
	<tbody>
		...
		<tr>
			...
			<td colspan="2" style="text-align:center; width:30%">&nbsp;<input type="date" class="form-control" name="tarikhMula" class="date" title="Bermula" value="{{ \Carbon\Carbon::parse($ebookings['tarikhMula'])->format('d-m-Y') }}" readonly /></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="4" rowspan="1">&nbsp;<textarea class="form-control" name="makanan" value="" style="height:80px" readonly >{{$ebookings['makanan']}}</textarea></td></td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="2" style="width:30%">&nbsp;<input type="text" class="form-control" name="tarikh_pemohon" value="<?php echo date('d-m-Y'); ?>" readonly /></td>
			<td colspan="2" style="width:30%">&nbsp;</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td colspan="4" rowspan="1">&nbsp;<textarea class="form-control" name="catatan_tukar" value="" style="height:80px" required >{{$ebookings['catatan_tukar']}}</textarea></td>
		</tr>
		<tr>
			<td style="width:40%"></td>
		...
		<tr>
			<td style="width:40%"></td>
			<td colspan="4" rowspan="1"><input type="checkbox" name="mohon_tukar" value="tukar" required>&nbsp; Pengesahan Penukaran Pemohon</td>
		</tr>
	</tbody>
</table>